                ...
                <section className="bg-gradient-to-r from-blue-600 to-cyan-600 rounded-2xl shadow-lg p-12 text-center">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center items-center flex-wrap">
                        ...
                        <div className="relative group">
                            <a
                                href="https://patronite.pl/MojeRepertorium"
                                target="_blank"
                                rel="noopener noreferrer"
                                className="inline-flex items-center gap-2 bg-blue-700 text-white px-8 py-4 rounded-lg font-semibold hover:bg-blue-800 transition-all border border-blue-500"
                            >
                                <Heart size={20} />
                                Wesprzyj nas
                            </a>
